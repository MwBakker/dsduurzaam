...
.why-card {
  ...
  padding: 30px; /* Vergroot de padding */
  box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1); /* Vergroot de schaduw voor meer diepte */
  display: flex;
...
.why-card-icon {
  width: 80px; /* Vergroot de icoon */
  height: 80px;
  margin-bottom: 25px; /* Iets meer ruimte tussen het icoon en de tekst */
}
