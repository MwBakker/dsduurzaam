...
#container-text {
    flex: 0 0 20%;
    /* Zet de breedte van de tekstsectie op 20% */
    padding: 115px 50px;
    background-color: #2c5484;
    /* Achtergrondkleur van de tekstsectie */
    color: white;
    /* Tekstkleur voor contrast */
    z-index: 1;
...
#new-container {
    ...
    box-sizing: border-box;
    /* Zorgt ervoor dat padding wordt meegenomen in de hoogte */
}
