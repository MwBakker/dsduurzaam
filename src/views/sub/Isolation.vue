<template>
  <div class="product">
    <div class="sub-product">
      ...
      <SubProductCard class="sub-card" title="Spouwmuurisolatie" amount="2500" image="isolation" />
    </div>
    <hr>
    <div class="sub-product">
      <SubProductCard class="sub-card" title="Vloerisolatie" amount="2500" image="isolation" />
