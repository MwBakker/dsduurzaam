<template>
  <div class="product">
    <div id="quotes">
      <QuoteCard title="Schuin dak" description="Een populaire en efficiënte manier om zonne-
      ...
      <QuoteCard title="Plat dak" description="Bieden een flexibele en efficiënte manier om zonne-
