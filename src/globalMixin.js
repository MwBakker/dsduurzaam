            ...
            headerMap: {
                'home': {
                    ...
                    'box': {
                        ...
                        'text1': 'Bespaar op uw gas- en stroomkosten en vergroot uw onafhankelijkheid met onze duurzame installaties. Verlaag uw energierekening, verhoog de waarde van uw woning en bescherm uzelf tegen stijgende energieprijzen. Wij bieden oplossingen voor elk budget.',
                        'text2': '',
                        'url': '',
                    },
                },
                ...
                'airco': {
                    ...
                    'box': {
                        ...
                        'text1': "Airco's zijn systemen die zowel kunnen koelen als verwarmen, waardoor ze het hele jaar door voor een comfortabele temperatuur zorgen.Ze zijn steeds energiezuiniger en dragen bij aan duurzaamheid, vooral wanneer ze gecombineerd worden met zonnepanelen die de benodigde stroom leveren.Hierdoor zijn airco’s een milieuvriendelijke en kostenefficiënte keuze voor klimaatregeling in huis of op kantoor.",
                        'text2': '',
                        'url': '',
                    },
                },
                'floor-heating': {
                    ...
                    'box': {
                        ...
                        'text1': 'Ervaar het ultieme comfort van vloerverwarming! Deze moderne verwarmingsoplossing werkt op lage temperaturen, waardoor het uiterst efficiënt is. Het zorgt voor een gelijkmatige warmteverdeling door uw hele huis, zonder koude plekken. Vloerverwarming is niet alleen energiezuinig, maar ook subtiel weggewerkt en geschikt voor verschillende soorten vloeren. Ontdek hoe deze duurzame manier van verwarmen uw huis aangenamer maakt en geniet het hele jaar door van een warm, comfortabel thuis.',
                        'text2': '',
                        'url': '',
                    },
                },
